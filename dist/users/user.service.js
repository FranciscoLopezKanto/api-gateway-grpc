...
let UsersService = class UsersService {
    ...
    onModuleInit() {
        this.usersService = this.usersServiceClient.getService(users_pb_1.USERS_SERVICE_NAME);
    }
    ...
    async createUser(request) {
        return (0, rxjs_1.firstValueFrom)(this.usersService.createUser(request));
    }
...
UsersService = __decorate([
    ...
    __param(0, (0, common_2.Inject)('UsersServiceClient')),
